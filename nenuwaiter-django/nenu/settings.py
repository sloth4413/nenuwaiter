# Django settings for nenu project.
import sae.const
DEBUG = True
...
SECRET_KEY = 'e8jh4ebxbiss&6#3uqx*n6=x3a_!cx261$*n=h5haqg*huj5zj'
...
ROOT_URLCONF = 'nenu.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'nenu.wsgi.application'
